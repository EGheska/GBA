...
func write_intro_labels():
	...
	if(config.get_value("language", "mode") == "dutch"):
		$"Control/ColorRect/Gameplay Explanation".text = "De auto's blijven consistent bewegen, beantwoord de vragen correct om je tegenstander in te halen!\n\nJouw auto is de groene auto!"
		...
		$"Control/ColorRect/Gameplay Explanation".text = "Your cars will move consistently, answer the questions correctly to overtake your opponent!\n\nYour car is the green car!"
